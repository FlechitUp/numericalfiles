...
type TTrapecio = class
  public
    ...
    function getArea(func :String; limit_a,limit_b: Real; N_trapezium : Integer): Real;
...
function TTrapecio.getArea(func :String; limit_a,limit_b: Real; N_trapezium : Integer): Real;
var
  m_function :TParseMath;
  i,h, resp,fa,fb,sum :Real;
  j :Integer;
